...
export const WorkspaceCreative: React.FC<WorkspaceCreativeProps> = ({
  ...
  const handleGenerateAd = () => {
    ...
    const timer3 = setTimeout(() => {
      ...
      // Prefer a real creative from this workspace over a stock placeholder — `assets`
      // already carries them, and an ad preview built from your own imagery is the point.
      const workspaceImg = assets.find(a => a.imageUrl)?.imageUrl || '';
      ...
      if (selectedAdType === 'Carousel') {
        setGeneratedAd({
          ...
          imageUrl: aiProductVisualRender || workspaceImg || PRODUCT_IMG,
          type: 'Carousel',
          platform,
          aspectRatio,
          cards: [
            { title: 'Slide 1: Powerhouse Capacity', desc: '20,000mAh Lithium Polymer Battery', img: productImg(600) },
        ...
        setGeneratedAd({
          ...
          imageUrl: aiProductVisualRender || workspaceImg || (selectedAdType === 'Video'
